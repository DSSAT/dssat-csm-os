...
!     &  WTNSR, WTSRO
     ...
     &  PLIPSR, POASR, PMINSR, ALPHSR, CMOBSRX, CADSRF, NMOBSRX, CLAIT,      
     &  YSTOR, FRSTRF, FRSTRMX, STRSRFL, STRLYR1, SENSR,
     &  FNPTD, FNPMD, FNPGD, HARD1, HARD2, FRZDC, FRZHRD, 
     &  FRZDHD, RDRMG, RDRMM, RDRMT, RCHDP

      REAL FRLF, FRSTM, FRRT
...
!CHP TEMP     &   (1X,F6.1),1X,F8.3,2(1X,F5.1),2(1X,F5.2),3(1X,F5.1))
     ...
     &    RHOS*100., RHOSR*100., TGRO(12), TGROAV, PCNSD, 
     &    PCLSD, PCCSD
510     FORMAT(1X,I4,1X,I3.3,3(1X,I5),6(1X,F6.2),F6.2,3(1X,F5.1),
     &   2(1X,F5.1),3(1X,F5.2))
