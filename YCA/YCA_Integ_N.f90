...
!***************************************************************************************************************************
    ...
    SUBROUTINE YCA_Integ_N ( &
        ...
        LEAFNEXCESS = 0.0
        IF (LANC > LNCX) LEAFNEXCESS = (LFWT-SENLFG-SENLFGRS)*(LANC-LNCX)                                          !EQN 245 !LPM 25OCT2015 to consider N by cohort LANC has to be by cohort
        ...
        !IF (SANC > SNCX) STEMNEXCESS = (STWT+CRWT)*(SANC-SNCX)                                                     !EQN 246
