...
!------------------------------------------------------------------------------
  ...
  length= Len('RUN,EXP,TR,RN,REP,YEAR,DOY,DAS,DAP,L#SD,GSTD,LAID,' &
  ...
  Header = 'RUN,EXP,TR,RN,REP,YEAR,DOY,DAS,DAP,L#SD,GSTD,LAID,' &
  //'LWAD,SWAD,GWAD,RWAD,VWAD,CWAD,G#AD,GWGD,HIAD,PWAD,P#AD,WSPD,WSGD,NSTD,' &
  //'PST1A,PST2A,KSTD,EWSD,LN%D,SH%D,HIPD,PWDD,PWTD,SLAD,CHTD,CWID,NWAD,RDPD,'&
...
!------------------------------------------------------------------------------
  ...
  length= Len('RUN,EXP,TR,RN,REP,YEAR,DOY,DAS,SWTD,SWXD,ROFC,DRNC,' &
  //'PREC,IR#C,IRRC,DTWT,MWTD,TDFD,TDFC,ROFD,') + Len(Trim(Adjustl(tmp)))

      Allocate(character(LEN=length) :: Header)

  Header = 'RUN,EXP,TR,RN,REP,YEAR,DOY,DAS,SWTD,SWXD,ROFC,DRNC,' &
...
!------------------------------------------------------------------------------
  ...
  length= Len('RUN,EXP,TR,RN,REP,YEAR,DOY,DAS,TS0D,') + &
          Len(Trim(Adjustl(tmp)))
  
       Allocate(character(LEN=length) :: Header)

  Header = 'RUN,EXP,TR,RN,REP,YEAR,DOY,DAS,TS0D,' // & 
            Trim(Adjustl(tmp))
