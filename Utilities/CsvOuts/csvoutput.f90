...
Subroutine CsvOutSumOpsum(RUN, TRTNUM, ROTNO, ROTOPT, REPNO, CROP, MODEL, &
   ...
   CWAM, HWAM, HWAH, BWAH, EYLD, PWAM, HWUM, HNUMUM, HIAM, LAIX, HNUMAM, &
...
!  Input vars
   ...
   Real, Intent (IN) :: HWAH, BWAH, HWAHF, FBWAH, EYLD
...
!  Recalculated vars
   Integer :: cHWAH1, cBWAH1, cHWAHF1, cFBWAH1, cEYLD
   ...
   CWAM, HWAM, cHWAH1, cBWAH1, cEYLD, PWAM, HWUM, HNUMAM, HNUMUM, HIAM, LAIX, &
