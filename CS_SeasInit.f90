!***************************************************************************************************************************
! This is the code from the section (DYNAMIC.EQ.SEASINIT) lines 1826 - 3941 of the original CSCAS code. The names of the 
...
!
! Subroutine CS_SeasInit calls six subroutines to initialize state and rate variables, read the Xfile, set the planting 
...
!***************************************************************************************************************************
    SUBROUTINE CS_SeasInit ( &  
        ...
        REAL    ALBEDO      , BRSTAGE     , CAID        , CANHT       , CLOUDS      , DEWDUR      , HARVFRAC(2) , KCAN        
