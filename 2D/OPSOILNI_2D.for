C=======================================================================
C  OpSoilNi_2D, Subroutine, C.H.Porter from Soil Nitrogen and Carbon 
C     portions of OPDAY
...
C=======================================================================
      ...
      SUBROUTINE OpSoilNi_2D(CONTROL, ISWITCH, SoilProp, 
...
!-----------------------------------------------------------------------
      ...
      INTEGER NAPFER(NELEM), LRow

      REAL AMTFER(NELEM)
      REAL TNH4, TNH4NO3, TNO3
    ! REAL NO3(NL), NH4(NL)
      REAL, DIMENSION(MaxRows,MaxCols) :: NH4_2D, NO3_2D
...
C-----------------------------------------------------------------------
  ...
  115     FORMAT('NMNC    NITC    NDNC    NIMC    AMLC   NNMNC    NUCM')
     ...
     &        (NO3_2D(LRow,I),I=1,MaxCols),(NH4_2D(LRow,I),I=1,MaxCols),
    !JW  &         (NO3(I),I=1,N_LYR), (NH4(I),I=1,N_LYR),
...
!***********************************************************************
      RETURN
      END SUBROUTINE OpSoilNi_2D
C-------------------------------------------------------------------
C
!==========================================================================
! OpSoilNi_2D Variable List
!==========================================================================
...
! FertData   Type of fertilizer application
! NH4_2D(L,J)    Ammonium N in soil layer L (µg[N] / g[soil])
! NO3_2D(L,J)    Nitrate N in soil layer L (µg[N] / g[soil])! NO3_2D  
...
!==========================================================================
! reference OPWBAL_2D
! How to output 2D? shall we add column index fiels? or output cell detail?
! output CellDetailN.OUT should be in this subroutine or in the WBAL_2D.for (Water cell detail is in the WBAL_2D_ts.for. Nitrogen do not have ts time step
