Module CS_First_Trans_m
    ...
    REAL    :: AFLF(0:LNUMX)       ! CH2O factor for leaf,average   #          ! (From SeasInit)  
    ...
    REAL    :: LAPOTX(LNUMX)       ! Leaf area potentials,maxima    cm2/l      ! (From SeasInit)  
    ...
    REAL    :: LATL2(LNUMX)        ! Leaf area,shoot,lf#,+h2o,n,tem cm2/l      ! (From SeasInit)  
    REAL    :: LATL3(LNUMX)        ! Leaf area,shoot,lf#,+assim.    cm2/l      ! (From SeasInit)  
    REAL    :: LATL4(LNUMX)        ! Leaf area,shoot,lf#,+assim.+N  cm2/l      ! (From SeasInit)  
    REAL    :: LATLPOT(LNUMX)      ! Leaf area,shoot,leaf,pot       cm2/l      ! (From Growth)    
    REAL    :: LATLPREV(LNUMX)     ! Leaf area,shoot,leaf,prev.     cm2/l      ! (From Growth)    
    ...
    REAL    :: NFLF(LNUMX)         ! N factor for leaf,average      #          ! (From SeasInit)  
    REAL    :: NFLF2(0:LNUMX)      ! N factor for leaf area adj     #          ! (From SeasInit)  
    ...
    REAL    :: WFLF(LNUMX)         ! H2O factor for leaf,average    #          ! (From SeasInit)  
