...
!-----------------------------------------------------------------------
     ...
     &  STANDARD, TVINSTR, STANDC, AMAKEABV, ARAYREAD, T
...
!-----------------------------------------------------------------------
      ...
      IMPLICIT NONE
      EXTERNAL Getlun, XREADC, Y4K_DOY, T, TVRFROMCCDE, TVRFROMC
...
!-----------------------------------------------------------------------
      ...
      EXTERNAL T, TVRFROMCCDE, TVRFROMC, XREADT, CSYEARDOY, TVIFROMC
