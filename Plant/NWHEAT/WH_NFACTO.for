...
C----------------------------------------------------------------------
      ...
      SUBROUTINE WH_NFACTO(DYNAMIC,               !Control
...
!======================================================================
      ...
      subroutine nwheats_set_nconc (xstag_nw, istage,            !Input
     &      zstage, VSEN,                                        !Input
     &      cnc, mnc)                                           !Output
!======================================================================
      USE WH_module
...
*+  Constant Values
      ...
      parameter (myname = 'nwheats_set_nconc')
*
...
*+  Constant Values
      character  myname*(*)            ! name of subroutine
      parameter (myname = 'nwheats_set_nfact')
