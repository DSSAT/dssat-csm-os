...
!  Called by: WH_PHENOL
!=======================================================================
      SUBROUTINE StageFlags (CONTROL, FILEIO, 
      ! fstage is output
     &    dc_code, fstage, istage, istageno, pgdd, pl_la,         !INPUT
     &    PLTPOP, sen_la, sumstgdtt, xs_nw, zs_nw,                !INPUT
     &    lstage, nwheats_dc_code, nwheats_pstag,                 !OUTPT
...
!            JZW never go here, these statement are repeated in call routing
...
!         JZW is it reasonable for PLTPOP<5?
...
!          JZW this is repeated calculate fstage from above
           fstage = ttime / stime 
         endif
