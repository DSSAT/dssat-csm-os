Module YCA_First_Trans_m
    ...
    REAL    :: CO2PAV(0:PSX)            ! CO2 concentration in air       g/m3       ! (From SeasInit)  
    ...
    REAL    :: DAYLPAV(0:PSX)           ! Daylength (6deg) av for tier   h          ! (From SeasInit)  
    ...
    REAL    :: StemGrowthP                  ! Potential stem growth rate     g/p        ! LPM11APR15  
    ...
    REAL    :: NFGPAV(0:PSX)            ! N factor,growth,average,tier   #          ! (From SeasInit)  
    ...
    REAL    :: NFPPAV(0:PSX)            ! N factor,phs,average,tier      #          ! (From SeasInit)  
    ...
    REAL    :: RAINPAV(0:PSX)           ! Rainfall,average for tier      mm         ! (From SeasInit)  
    ...
    REAL    :: SRADPAV(0:PSX)           ! Solar radiation,tier average   MJ/m2      ! (From SeasInit)  
    ...
    REAL    :: TMAXPAV(0:PSX)           ! Temperature,maximum,tier av    C          ! (From SeasInit)  
    ...
    REAL    :: TMINPAV(0:PSX)           ! Temperature,minimum,tier av    C          ! (From SeasInit)  
    ...
    REAL    :: WFGPAV(0:PSX)            ! Water factor,growth,average    #          ! (From SeasInit)  
    ...
    REAL    :: WFPPAV(0:PSX)            ! Water factor,phs,average 0-1   #          ! (From SeasInit)  
