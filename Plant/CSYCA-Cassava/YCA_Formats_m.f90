...
!=======================================================================
    ...
    MODULE YCA_Formats_m
        ...
        CHARACTER(LEN=268) :: FMT501 = '(I5,I4,2I6,F6.1,A6,F6.1,F6.3,F6.2,F6.1,A6,F6.3,A6,4I6,4I6,F6.1,F6.3,I6,2A6,F6.2,' // & ! issue 50
        ...
        CHARACTER(LEN=390) :: FMT2201 = '("@YEAR DOY   DAS   DAP TMEAN","  GSTD  L#SD"," PARID PARUD  AWAD",' // &
            '"  LAID  SAID  CAID","  TWAD SDWAD  RWAD  CWAD  LWAD  SWAD  HWAD  HWFD  DMHD  HIAD"," RSWAD SNWLD SNWSD",' // &
