...
C Calls:     None
C=======================================================================
      SUBROUTINE ROOTWU(DYNAMIC,YRDOY,
...
csvc # check why CAD counts more them CAD at deep soils
          WRITE(882,*)YRDOY,DAS,L,RWU(L),SW(L),LL(L),DLAYR(L),RLV(L)
