    ...
    SUBROUTINE CS_Out_PlGrow ( & 
        ...
        IF ((IDETG.NE.'N'.AND.IDETL.NE.'0').OR.IDETL.EQ.'A') THEN
            ...
            WRITE (NOUTPG, FMT501)YEAR,DOY,DAS,DAP,TMEAN,BRSTAGEC,LNUM,PARIOUT,PARIUE,AMIN1(999.9,CARBOBEG*PLTPOP*10.0), &
                ...
                HIAD, 0,NINT(RSWAD),SENTOPLITTERAC,SENROOTC,RSCD*100.0,NINT(HNUMAD),HWUDC,NINT(BRNUMST(L)), &
            ...
            ! End Plantgro writes
              !WRITE (*, FMT501)YEAR,DOY,DAS,DAP,TMEAN,BRSTAGEC,LNUM,PARIOUT,PARIUE,AMIN1(999.9,CARBOBEG*PLTPOP*10.0), &
            ...
            WRITE (NOUTPG2, FMT502)YEAR,DOY,DAS,DAP,TMEAN,BRSTAGEC,BRSTAGE,LAIPRODC,SENLA*PLTPOP*0.0001,LAIC, &
                !CANHTC,SDWAD,SENTOPLITTERAC,SENROOTC,NINT(HNUMAD),HWUDC,SHRTD,PTF,RTDEP/100.0,(RLV(I),I=1,10) !LPM 19MAY2015 to delete PTF as output
                  CANHTC,SDWT,SENTOPLITTERAC,SENROOTC,NINT(HNUMAD),HWUDC,SHRTD,RTDEP/100.0,(RLV(I),I=1,10)    
            ! End PlantGr2 writes
