...
!------------------------------------------------------------------------------    
  ...
  length= Len('RUN,EXP,TR,RN,REP,YEAR,DOY,DAS,NAPC,NI#M,NIAD,NITD,NHTD,' &
  //'NI1D,NI2D,NI3D,NI4D,NI5D,NI6D,NI7D,NI8D,NI9D,NH1D,NH2D,NH3D,NH4D,NH5D,' &
  //'NH6D,NH7D,NH8D,NH9D,NMNC,NITC,NDNC,NIMC,AMLC,NNMNC,NUCM,NLCC')

      Allocate(character(LEN=length) :: Header)

  Header = 'RUN,EXP,TR,RN,REP,YEAR,DOY,DAS,NAPC,NI#M,NIAD,NITD,NHTD,' &
  //'NI1D,NI2D,NI3D,NI4D,NI5D,NI6D,NI7D,NI8D,NI9D,NH1D,NH2D,NH3D,NH4D,NH5D,' &
  //'NH6D,NH7D,NH8D,NH9D,NMNC,NITC,NDNC,NIMC,AMLC,NNMNC,NUCM,NLCC' 
