...
!     USE CS_Albedo_Check_m.
!       
!     All variables, apart from those that are arguments of CSCAS, are declared in the module CS_First_Trans_m.f90,
...
!     CS_Formats_m.f90, which is USEd as necessary.
!       
