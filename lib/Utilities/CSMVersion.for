...
!     CHARACTER(len=*), PARAMETER :: VBranch = '-xmake'
      CHARACTER(len=*), PARAMETER :: VBranch = '-develop'

!     Version history:  
!       4.7.5.42 chp 07/20/2021 Fix bug with incorporated OM
!       4.7.5.41 chp 06/18/2021 Lat-long in Summary, wheat evaluate fix
!       4.7.5.40 chp 06/08/2021 Freshweight headers in Summary.CSV
!       4.7.5.39 chp 06/04/2021 SW init for static memory
!       4.7.5.38 chp 06/01/2021 Allow TMAX=TMIN
!       4.7.5.37 chp 05/14/2021 Update genotype files, cassava, fresh weight to summary
!       4.7.5.36 chp 04/23/2021 Major update to MANIHOT model. Fresh wt update.
