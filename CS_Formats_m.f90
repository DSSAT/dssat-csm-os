...
!=======================================================================
    ...
    MODULE CS_Formats_m
        ...
        CHARACTER(LEN=128) :: FMT409 = '(I6,A6,I6,I6,A6,F6.1,13F6.1,I6,I6,A6,I6,A6,I6,I6,I6,A6,F6.1,I6,3F6.1,I6)' !LPM 28MAR15 To change the format of plantres.OUT
        ...
        CHARACTER(LEN=256) :: FMT501 = '(I5,I4,2I6,F6.1,A6,F6.1,F6.3,F6.2,F6.1,A6,F6.3,A6,4I6,3I6,F6.3,2I6,2A6,F6.2,I6,A6,' // &
            'I6,F6.1,2F6.2,F6.1,F6.1, F6.2,2F6.2,2F6.2,F6.1,2F6.2,F6.2)'
        CHARACTER(LEN=128) :: FMT502 = '(I5,I4,2I6,F6.1,A6,F6.2,A6,F6.2,A6,A6,F6.1,2A6,I6,A6,2F6.2,F6.3,10F6.2)'
        ...
        CHARACTER(LEN=256) :: FMT2251 = '("@YEAR DOY   DAS   DAP TMEAN  GSTD  RSTD"," LAIPD LAISD  LAID  CHTD SDWAD ",' // &
            '"SNWLD SNWSD  H#AD  HWUD"," SHRTD  PTFD  RDPD","  RL1D  RL2D  RL3D  RL4D  RL5D  RL6D  RL7D  RL8D",' // &
            '"  RL9D RL10D")'
